...
/**DBException for Query Errors.
 * @author Timo
 */
class DBException(exception:String) extends Exception{
	/**The serial version UID of DBException with value {@value}.*/
	val  serialVersionUID = -6082914704351652365L;
