...
<xsl:template match="recipeentry">
...
<fo:block font-weight="bold"><xsl:value-of select="recipelist"/></fo:block>
<fo:table>
<fo:table-column/>
<fo:table-column/>
<fo:table-column/>
...
<fo:table-cell>
<fo:block font-weight="bold"><xsl:value-of select="category"/></fo:block>
</fo:table-cell>
<fo:table-cell>
<fo:block font-weight="bold"><xsl:value-of select="time"/></fo:block>
</fo:table-cell>
<fo:table-cell>
<fo:block font-weight="bold"><xsl:value-of select="rating"/></fo:block>
</fo:table-cell>
<fo:table-cell>
<fo:block font-weight="bold"><xsl:value-of select="ingredient"/></fo:block>
</fo:table-cell>
</fo:table-row>
...
<fo:table-cell>
<fo:block><xsl:value-of select="ingredient"/></fo:block>
</fo:table-cell>
</fo:table-row>
</xsl:for-each>
</fo:table-body>
